  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-800">Legislação Fiscal</h1>
          <p className="text-lg text-gray-600">
            Tributos federais, estaduais e municipais. ICMS, ISS, IPI, PIS, COFINS, IR e todas as obrigações acessórias com análises detalhadas.
          </p>
        </div>
